...
int main()
{
	stDate VacationFrom, VacationTo;
	ReadVacationPeriod(VacationFrom, VacationTo);

	cout << "\nVacation from: "; PrintDate(VacationFrom);
	cout << "\nVacation To  : "; PrintDate(VacationTo);
	cout << "\nActual vacation days is : " << CalculateVacationDays(VacationFrom, VacationTo) << endl;
	return 0;
}