...
int main()
{
	...
	{
		cout << "Yes, It is the last day in month.\n";
	}
	else
	{
		cout << "No, It is Not the last day in month.\n";
	}
	if (IsLastMonthInYear(Date.Month))
	{
		cout << "Yes, It is the last Month in Year.\n";
	}
	else
		cout << "No, It is NOT the last Month in Year.\n";
