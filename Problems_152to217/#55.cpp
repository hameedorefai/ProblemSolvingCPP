...
int main()
{
	...
	ReadVacationPeriod(VacationFrom, VacationDays);


	stDate VactionEndDate = GetVacationEndDate(VacationFrom, VacationDays);




	cout << "\Return Date: "; PrintDate(VactionEndDate);
