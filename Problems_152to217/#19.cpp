...
int main()
{
	...
	cout << "Difference is : " << GetDifferenceBetween2DatesByDays(Date1, Date2) << " day(s)" << endl;
	cout << "Difference include end day is : " << GetDifferenceBetween2DatesByDays(Date1, Date2,1) <<" day(s)" << endl;
